...
async def recup_data_équipe_une_année(année: int = 2023) :
...
async def recup_data(prem_année : int = 2000, der_année: int = 2023):
        ...
        with tqdm(total=total_years, desc="Progression", colour='green') as pbar:
            for année in range(prem_année, der_année):
